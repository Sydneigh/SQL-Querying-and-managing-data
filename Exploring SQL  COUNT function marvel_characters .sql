...
SELECT MAX(weight_kg), weight_kg NUMERIC, name  FROM marvels;
SELECT MIN(weight_kg), weight_kg NUMERIC, name FROM marvels;
SELECT AVG(weight_kg), weight_kg NUMERIC, name FROM marvels;

SELECT weight_kg NUMERIC, name FROM marvels GROUP BY name HAVING weight_kg > 100;

SELECT weight_kg NUMERIC, name, hometown, speed FROM marvels WHERE weight_kg > 50 AND speed > 10;
