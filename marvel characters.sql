...
SELECT MAX(weight_kg), weight_kg , name  FROM marvels;
SELECT MIN(weight_kg), weight_kg , name FROM marvels;
SELECT AVG(weight_kg), weight_kg , name FROM marvels;

SELECT MAX(durability),  durability, name FROM marvels;
SELECT MIN(durability), durability, name FROM marvels;
SELECT AVG(durability), durability, name FROM marvels;

SELECT AVG(weight_kg), AVG(durability), name FROM marvels;



SELECT name, weight_kg, durability, fighting_Skills, COUNT(*),
      CASE
      WHEN fighting_Skills > 1  THEN "weak"
      WHEN durability > 2 THEN "weak"
 END as "weakest_fighter"
 FROM marvels;
